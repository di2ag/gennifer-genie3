...
from .tasks import create_genie3_task
...
# Initialise environment variables
    ...
    requests_cache.install_cache('genie3_cache')
    ...
    class RunAlgorithm(Resource):
        ...
        def post(self):
            ...
            task = create_genie3_task.delay(args["zenodo_id"])
    ...
    class AlgorithmInfo(Resource):
        ...
        def get(self):
            ...
            info = {
                    "name": 'genie3',
                    "description": 'The current implementation of GENIE3 takes an expression matrix and a list of genes as input. It produces a ranked list of edges as output, which we used directly in our analysis.',
                    "edge_weight_type": '',
